...
const robots = await RobotsFile.find('https://www.drsimi.cl/medicamento/salud-femenina?page=1')
...
router.addHandler('PASTILLAS', async ({ page, enqueueLinks, log }) => {
    ...
    const url = await page.waitForSelector('a.vtex-product-summary-2-x-clearLink', { timeout: 30000 });
...
router.addDefaultHandler(async ({ page, enqueueLinks, log }) => {
    ...
    const url = await page.waitForSelector('a.vtex-product-summary-2-x-clearLink');
